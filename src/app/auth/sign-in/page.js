  ...
  return (
    <div className="h-screen flex justify-between items-center mx-12 py-6 gap-5">
      <div className="w-full">
        ...
        >
          <span className="font-bold">Silakan login dulu, ya!</span> <br></br>{" "}
          Masukkan username dan password kamu dengan benar biar bisa lanjut ke
          halaman selanjutnya. Jangan sampai salah, soalnya cuma yang
          bener-bener punya akun yang bisa masuk 🔐😉
        </p>
        <form
          className=""
          action=""
        ...
        >
          ...
          <div
            ...
            data-aos-duration="1500"
          >
            <span className="font-bold">Belum punya akun?</span> <br></br>
            Tenang aja, kamu bisa langsung{" "}
            <Link
              href="/auth/sign-up"
            ...
            di sini dan gabung bareng yang lain! 🚀✨
          </div>
        </form>
      </div>
      <div
